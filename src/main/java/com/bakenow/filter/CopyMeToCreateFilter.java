 ...
 * @author Admin
 */
@WebFilter(filterName = "CopyMeToCreateFilters", urlPatterns = {"/forever-alone"}, dispatcherTypes = {DispatcherType.ERROR})
public class CopyMeToCreateFilter implements Filter {
    ...
    public CopyMeToCreateFilter() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CopyMeToCreateFilters:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CopyMeToCreateFilters:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CopyMeToCreateFilters:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CopyMeToCreateFilters: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CopyMeToCreateFilters()");
        }
        StringBuffer sb = new StringBuffer("CopyMeToCreateFilters(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CopyMeToCreateFilters::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CopyMeToCreateFilters::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CopyMeToCreateFilters::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CopyMeToCreateFilters::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CopyMeToCreateFilters::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
