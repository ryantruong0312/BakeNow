 ...
 * @author tlminh
 */
public class CommentRecipeController extends HttpServlet {

    public static final String ERROR = "MainController?action=NavToLogin";
    public static final String SUCCESS = "ViewRecipeController?recipeId=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.addRecipeComment(recipeId,userId,contents)){
