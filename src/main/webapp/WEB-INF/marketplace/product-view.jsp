                    ...
                    <div class="product_info_container">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="py-2 col-5" style="padding-top: 50px;">
                                <div class="product_price" style="font-size: 35px; text-align: end; margin: 10px 0;">${requestScope.PRODUCT.getPrice()} $</div>
                                <form action="MainController" class="d-flex">
                                    ...
                                    <input type="submit" id="add_to_cart_btn" class="btn product_add-to-cart_btn col-5" name="action" value="Add to cart">
                                </form>
                            </div>
                        </div>
                    </div>
