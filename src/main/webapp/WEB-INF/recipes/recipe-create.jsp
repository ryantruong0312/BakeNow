                ...
                <div class="create_recipe col-10">
                    ...
                    <div class="d-flex justify-content-center my-3 py-3" style="background-color: #fff;">
                        <form action="" class="create_recipe_form col-10">
                            <div class="py-2" > 
                                <span style="font-size: 24px; font-weight: bold;">Title</span> <input type="text" style="width: 100%; padding-left: 10px;" name="title" required="" placeholder="Choose a title ...">
                            </div>
                            <div class="py-2" > 
                                <span style="font-size: 24px; font-weight: bold;">Description</span> <textarea type="text" style="padding-left: 10px; width: 100%; height: 120px;" name="desc" required="" placeholder="Something about your recipe ..."></textarea>
                            </div>
                            <div class="py-2" > 
                                <span style="font-size: 24px; font-weight: bold;">Cook time</span> <input type="number" style="width: 75px; padding-left: 10px;" name="cookTime" required="">
                            </div>
                            <div class="py-2 d-flex justify-content-center">
                                <div class="col-4 py-2">
                                    ...
                                    <div style="text-align: center; margin-top: 10px;">
                                        <span>Image URL</span><input style="width: 300px; margin: 10px; padding-left: 10px;" type="text" name="imgUrl" placeholder="Image link address ...">
                                    </div>
                                </div>
                            </div>
                            <div class="py-2" > 
                                ...
                                <div class="recipe_create_form_step">
                                    <div style="font-size: 20px; padding-left: 10px">
                                        <span class="recipe_create_form_step_counter"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-11">
                                            <textarea class="my-2 py-2" type="text" style=" padding-left: 10px; width: 100%; min-height: 130px;" name="stepContent" required="" placeholder="Enter the direction ..."></textarea>
                                        </div>
                                ...
                                <div class="create_recipe_form_supply_ingredient col-7 my-4">
                                    ...
                                    <div class="p-2 my-2" style="border: 1px solid #D9D9D9; border-radius: 5px;">
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" class="supply col-7 mx-1 my-2" style="padding-left: 10px;" name="ingredientName" required="">
                                                <input type="text" class="supply col-4 mx-1 my-2" style="padding-left: 10px;" name="amount">
                                ...
                                <div class="create_recipe_form_supply_tool col-5 my-4 mx-2">
                                    ...
                                    <div class="p-2 my-2" style="border: 1px solid #D9D9D9; border-radius: 5px;">
                                        <div class="col-10 mx-1 d-flex justify-content-center" style="font-size: 20px;">Name</div>
                                            <div class="d-flex">
                                                <input type="text" class="supply col-10 mx-1 my-2" style="padding-left: 10px;" name="toolName" required="">
                                                <i class="bi bi-dash-circle col-1 d-flex align-items-center removeSupply" style="font-size: 30px;"></i>
                                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <input type="hidden" name="authorId" value="${sessionScope.LOGIN_USER.id}">
                                <input class="last_button mx-2" type="submit" name="action" value="Create">
                                <a class="last_button" style="padding-top: 5px;" href="MainController?action=NavToBlogHome">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
